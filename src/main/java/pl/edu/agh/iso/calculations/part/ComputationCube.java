...
import pl.edu.agh.iso.calculations.data.InterpolatedFunction;
import pl.edu.agh.iso.calculations.function.BaseFunctionDerivativeCombination;
import pl.edu.agh.iso.calculations.function.BaseFunctionWrapper;
import pl.edu.agh.iso.calculations.function.Dimension;
import pl.edu.agh.iso.calculations.function.InteriorBaseFunction;
import pl.edu.agh.iso.calculations.function.TripArgFunction;
import pl.edu.agh.iso.calculations.function.TripArgFunctionProduct;
import pl.edu.agh.iso.calculations.function.FaceBaseFunctions;
import pl.edu.agh.iso.calculations.function.EdgeBaseFunctions;
import pl.edu.agh.iso.calculations.function.PointBaseFunctions;
import pl.edu.agh.iso.calculations.integrals.GaussianQuadrature;
